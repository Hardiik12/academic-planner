  ...
  return (
    <div
      className={`min-h-screen flex ${
        isAuthPage
          ? "bg-gray-100" // clean background for login/signup
      ...
      {!isAuthPage && (
        <aside className="w-64 bg-white/70 backdrop-blur-xl shadow-xl p-6 flex flex-col">
          ...
          {user && (
            <button
              onClick={logout}
              className="mt-auto flex items-center justify-center gap-2 bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-xl"
            >
              <FaSignOutAlt />
              Logout
            </button>
